...
{
    for (unsigned i = length; i < _blockSize; ++i)
    {
        int64_t sum = 0;
...
static void decodeFile(BitInputStream &in, ostream &os)
{
...
BitInputStream::BitInputStream(istream *is) : _is(is)
{
}
