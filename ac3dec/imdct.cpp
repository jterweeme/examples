...
static void ifft_pass(complex_t *buf, sample_t *weight, int n)
{
    ...
    do {
    tmp5 = buf2[0].real * weight[n] + buf2[0].imag * weight[2*i];
    tmp6 = buf2[0].imag * weight[n] - buf2[0].real * weight[2*i];
    tmp7 = buf3[0].real * weight[n] - buf3[0].imag * weight[2*i];
    tmp8 = buf3[0].imag * weight[n] + buf3[0].real * weight[2*i];
    tmp1 = tmp5 + tmp7;
    tmp2 = tmp6 + tmp8;
    tmp3 = tmp6 - tmp8;
    tmp4 = tmp7 - tmp5;
    buf2[0].real = buf[0].real - tmp1;
    buf2[0].imag = buf[0].imag - tmp2;
    buf3[0].real = buf1[0].real - tmp3;
    buf3[0].imag = buf1[0].imag - tmp4;
    buf[0].real += tmp1;
    buf[0].imag += tmp2;
    buf1[0].real += tmp3;
    buf1[0].imag += tmp4;
